/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareEnv env.d.ts` (hash: ffef2670bf3f7ef87fdfb15e0dcdc0fe)
...
declare namespace Cloudflare {
  ...
  interface Env {
    ...
    ASSETS: Fetcher;
    NEXT_PUBLIC_SITE_URL: 'https://xvideodownloader.org';
    NEXT_PUBLIC_FILE_PUBLIC_URL: 'https://files.xvideodownloader.org';
    NODEJS_ENV: string;
...
declare namespace NodeJS {
  interface ProcessEnv
    extends StringifyValues<
        Pick<
          Cloudflare.Env,
          'NEXT_PUBLIC_SITE_URL' | 'NEXT_PUBLIC_FILE_PUBLIC_URL' | 'NODEJS_ENV' | 'XDOWN_INTERNAL_SECRET'
        >
      >,
      Pick<
        Cloudflare.Env,
